...
| 5 / GUG-123 | GUG-84, GUG-87, GUG-109, GUG-119 | Protected deployment Environments, exact OIDC trust, terminal roles, access analysis, independent approver | GUG-123 now owns the atomic repository implementation; live Environment/IAM evidence and the second-approver operating proof remain blocked until an authorized execution |
