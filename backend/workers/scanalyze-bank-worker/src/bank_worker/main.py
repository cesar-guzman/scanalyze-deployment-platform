...
from .processors.extract import process_bank_extract_message
...
def poll_queue(queue_url: str):
    ...
    log_event("worker_started", queue="bank-extract")
    ...
    while not shutdown_requested:
        try:
            ...
            for msg in messages:
                ...
                try:
                    success = process_bank_extract_message(body, receipt_handle, queue_url)
                    ...
                    # process_bank_extract_message is expected to handle specific errors,
...
def main():
    ...
    try:
        ...
        queue_url = config.get("queues/bank-extract_url")
