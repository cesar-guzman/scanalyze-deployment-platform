...
DOMAIN = "gov"
FINAL_STATUS = "GOV_EXTRACTED"
WRITING_STATUS = "GOV_EXTRACTING"
...
def _require_stage_artifact_binding(
    ...
    *,
    ...
    stage = (document_item.get("stages") or {}).get("gov_extract")
...
def process_gov_extract_message(body: str, receipt_handle: str, queue_url: str) -> bool:
    ...
    try:
        ...
        structured_key = (
            ...
            f"documents/{msg.documentId}/structured/gov/result.json"
        )
        ...
        if document_status == FINAL_STATUS:
            ...
            raise RuntimeError("Document is not ready for government extraction")
