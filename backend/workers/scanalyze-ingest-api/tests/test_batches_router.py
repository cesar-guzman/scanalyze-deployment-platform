...
def test_create_batch(mock_svc):
    ...
    mock_svc.create_batch.assert_called_once_with(
        tenant="tenant-a", subject="test-user", email=None, name=None, metadata={"source": "api"}
    )
...
def test_get_batch(mock_svc):
    ...
    mock_svc.get_batch.assert_called_once_with(tenant="tenant-a", batch_id="b-12345678")
...
def test_get_batch_documents(mock_svc):
    ...
    mock_svc.get_batch_documents.assert_called_once_with(tenant="tenant-a", batch_id="b-12345678")
...
def test_export_manifest(mock_svc):
    ...
    mock_svc.export_manifest.assert_called_once_with(tenant="tenant-a", batch_id="b-12345678")
...
def test_export_zip(mock_svc, tmp_path):
    ...
    mock_svc.export_zip.assert_called_once_with(tenant="tenant-a", batch_id="b-12345678")
