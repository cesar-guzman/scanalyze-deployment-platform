...
class TestClassifierWorker(unittest.TestCase):
    ...
    def test_happy_path_heuristic(self):
        ...
        msg_body = {
            "schemaVersion": "scanalyze.classify.v1",
            "documentId": "doc-123",
            "ocr": {"key": "path/obj.json"},
            "raw": {"key": "path/raw.pdf"},
            "meta": {"env": "test", "tenant": "tenant-test"}
        }
        ...
        self.assertEqual(kwargs['deduplication_id'], "doc-123-classify-v1")
    ...
    def test_poison_message(self):
        ...
        self.mock_delete.assert_called_once_with("https://sqs/classify", "receipt-poison")
